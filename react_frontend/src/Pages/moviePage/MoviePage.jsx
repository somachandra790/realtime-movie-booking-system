            ...
            <div className="container__movieDetail">
              ...
              <div className="container__movieDetail_rating">
                <img
                  ...
                  style={{ width: 25 }}
                />
                <h1>{data?.rating?.percentage ?? 89}%</h1>
                <p style={{ marginBottom: 0 }}>{Math.ceil(data?.rating?.no_of_ratings ?? 78545)} Ratings</p>
              </div>
              ...
              <div style={{ color: "white", fontSize: 18 }}>
                <h5 style={{ color: "white", fontSize: 18 }}>
                  {`${data?.duration} Mins - ${data?.genre} - ${data?.year}`}
                </h5>
              </div>
