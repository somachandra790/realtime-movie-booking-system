...
public class User implements Serializable {
	...
	@JsonIgnore
	private List<Movie> bookmarkedMovies = new ArrayList<Movie>();
	...
	public User(String firstname, String lastname, String image,  String email, String password) {
	...
	public User(UserInfo userInfo, String image) {		
	...
	public void setBookmarkedMovies(List<Movie> bookmarkedMovies) {
	...
	public void addToBookmarks(Movie movie) throws Exception {
	...
	public boolean removeFromBookmarks(Movie movie) throws Exception {
	...
	public String toString() {
		return "User [id=" + id + " " + this.userInfo + "]";
	}
