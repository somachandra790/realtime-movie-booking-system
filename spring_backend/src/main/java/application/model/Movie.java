...
//	@JsonProperty(access = Access.WRITE_ONLY) // Can use Password in HTTP Request but HTTP Response will not have password.
	...
	public Movie(String title, MovieGenre genre, String imagePath, Float rating, String description,  List<String> authors, List<String> actors, Integer year, String country, Integer duration, String trailer) {
		this.title = title;
		this.genre = genre;
	...
	public Movie(Long id, String title, MovieGenre genre, String image, Float rating, String description,  List<String> authors, List<String> actors, Integer year, String country, Integer duration, String trailer) {
		this.id = id;
		this.title = title;
		this.genre = genre;
		this.image = image;
